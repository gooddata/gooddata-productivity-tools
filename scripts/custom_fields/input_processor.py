...
This module contains the `CustomFieldsDataProcessor` class, which is responsible
for converting validated custom datasets and fields into objects defined in the
GoodData Python SDK.
"""

from custom_fields.models.aliases import _DatasetId  # type: ignore[import]
...
class CustomFieldsDataProcessor:
    ...
    def _date_ref_from_field(
        ...
        return CatalogDeclarativeReference(
            identifier=CatalogReferenceIdentifier(id=custom_field.cf_id),
            multivalue=False,
            sources=[
                CatalogDeclarativeReferenceSource(
                    ...
                    data_type=custom_field.cf_source_column_data_type.value,
                )
            ],
        )
    ...
    def _get_sources(
        ...
        CatalogDataSourceTableIdentifier | None, CatalogDeclarativeDatasetSql | None
    ]:
    ...
    def datasets_to_ldm(
        self, datasets: dict[_DatasetId, CustomDataset]
    ) -> CatalogDeclarativeModel:
        ...
        for dataset in datasets.values():
            ...
            for custom_field in dataset.custom_fields:
                ...
                # in the GoodData Logical Data Model.
                    ...
                    raise ValueError(
                        f"Unsupported custom field type: {custom_field.cf_type}"
                    )
